...
\bibitem [Bison]{Bison} \url {http://es.wikipedia.org/wiki/GNU_Bison}\\
\bibitem [Github]{Github} \url {http://wwwhatsnew.com/2008/04/07/github-repositorio-de-control-de-versiones-en-la-web/}\\
\bibitem [CSound]{CSound] \url {mazinger.sisib.uchile.cl/.../pa/.../b20053161222chapter1spanish.pdf }\\
\end{thebibliography}
